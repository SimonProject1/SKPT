(()=>{'use strict';
const VERSION='1.5.1',APP='SK PLT Tools',DEVELOPER='Simon Kiesler';
function update(){
  ...
  document.querySelectorAll('footer.footer').forEach(footer=>footer.innerHTML=`${APP} · <span class="stb-version">Version ${VERSION}</span> · Entwickelt von ${DEVELOPER}`);
}
